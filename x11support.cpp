...
void X11Support::setWindowPropertyDock(unsigned long window)
{
	long i_tmp = atom("_NET_WM_WINDOW_TYPE_DOCK");
	XChangeProperty(QX11Info::display(), window, atom("_NET_WM_WINDOW_TYPE"), XA_ATOM, 32, PropModeReplace, reinterpret_cast<const unsigned char*>(&i_tmp), 1);
}
